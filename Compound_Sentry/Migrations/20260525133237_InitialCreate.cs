...
namespace Compound_Sentry.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrentPresences", x => x.MacAddress);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MacAddress = table.Column<string>(type: "nvarchar(17)", maxLength: 17, nullable: false),
                    PhoneType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    EventType = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    SignalStrength = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurrentPresences_LastSeen",
                table: "CurrentPresences",
                column: "LastSeen");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceEvents_EventTimestamp",
                table: "DeviceEvents",
                column: "EventTimestamp");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceEvents_MacAddress",
                table: "DeviceEvents",
                column: "MacAddress");
        }
